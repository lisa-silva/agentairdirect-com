...
for(const marker of ['id="free-audit"','id="contact"','id="roi-calculator"','assets/roi-calculator.css','assets/roi-calculator.js','assets/roi-calculator-ui.js','assets/dollar-cursor-trail.css','assets/dollar-cursor-trail.js',`href="${auditDestination}"`,`action="https://formsubmit.co/hello@agentair.io"`,`value="New Free AI Visibility Audit Request"`])if(!html.includes(marker))throw new Error(`Production page is missing ${marker}`);
